      ...
      <div className="container-fluid cardContainer">
        {loading ? (
          ...
          <Row className="my-3 d-flex align-items-center justify-content-center">
              ...
              records?.map(restaurant => (
                <Col className="d-flex align-items-center justify-content-center" key={restaurant?.id}>
                  <div className="item item1">
                    <div className="shadow square" style={{ width: '15rem' }}>
                      <img
                        style={{ height: '320px', width: '100%', borderRadius: '13px' }}
                      ...
                      <div>
                        ...
                        <div className="d-flex justify-content-center">
                          <Link to={`${restaurant?.id}/view`} className="text-warning">
                            View More...
                          </Link>
                        </div>
                      </div>
            ...
            <div className="d-flex justify-content-center text-warning" style={{ paddingBottom: '20px' }}>
              <nav>
            ...
            <hr />
            <p className="text-center" style={{ paddingBottom: '10px' ,fontSize: '1.2em' }}>Copyright © 2024 Lettuce EAT BISTRO. Built with React
